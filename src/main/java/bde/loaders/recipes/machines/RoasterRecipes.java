...
public class RoasterRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Molybdenum, 1))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Nickel, 2))
            .fluidOutputs(Materials.SulfurDioxide.getGas(1000))
            .eut(16)
            .duration(25 * SECONDS + 12 * TICKS)
            .addTo(roasterRecipes);
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Antimony, 1)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(4000))
            .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Zinc, 2))
            .fluidOutputs(Materials.SulfurDioxide.getGas(1000))
            .eut(16)
            .duration(25 * SECONDS + 12 * TICKS)
            .addTo(roasterRecipes);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(3000))
            .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Iron, 1))
            .fluidOutputs(Materials.SulfurDioxide.getGas(1000))
            .eut(16)
            .duration(25 * SECONDS + 12 * TICKS)
            .addTo(roasterRecipes);
        GT_Values.RA.stdBuilder()
            ...
            .fluidInputs(Materials.Oxygen.getGas(8000))
            .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Sulfur, 1))
            .outputChances(1000)
